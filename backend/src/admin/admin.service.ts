...
import {
  ...
  type ProjectCostDashboardDto,
} from './project-cost-dashboard.service';
...
export class AdminService {
  constructor(
    ...
    private readonly projectCostDashboardService: ProjectCostDashboardService,
  ...
  async getProjectCostDashboard(): Promise<ProjectCostDashboardDto> {
    return this.projectCostDashboardService.getProjectCostDashboard();
  }
}
