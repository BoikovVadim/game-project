...
import { TournamentRoundResolution } from './tournament-round-resolution.entity';
...
@Module({
  imports: [
    TypeOrmModule.forFeature([Tournament, Question, QuestionPoolItem, TournamentEntry, TournamentResult, TournamentProgress, TournamentEscrow, TournamentRoundResolution, User, Transaction]),
