...
@Module({
  imports: [
    ...
    TypeOrmModule.forRoot({
      ...
      entities: [User, Tournament, Question, TournamentEntry, TournamentResult, TournamentProgress, TournamentEscrow, Transaction, Payment, WithdrawalRequest, SupportMessage, SupportTicket],
      synchronize: true,
      logging: true,
    }),
    MailModule,
